...
|---|---|
| Networking & Security Fundamentals | TCP/IP, DNS, VPNs, Firewalls, IDS/IPS, OSI Model |
| Linux & Windows Administration | Active Directory, Group Policy, Windows Server, Linux (Kali), CLI |
...
|---|---|
| [networking-security-foundations](./networking-security-foundations) | Core networking and security fundamentals labs |
| [linux-windows-administration](./linux-windows-administration) | Linux/Windows system administration labs, including AD and hardening |
| [virtualization-containers](./virtualization-containers) | Virtualization and container labs |
| [network-security-cryptography](./network-security-cryptography) | Network security and cryptography labs |
| [next-gen-firewalls](./next-gen-firewalls) | Next-gen firewall configuration and testing |
| [threats-vulnerabilities](./threats-vulnerabilities) | Threat and vulnerability analysis labs |
